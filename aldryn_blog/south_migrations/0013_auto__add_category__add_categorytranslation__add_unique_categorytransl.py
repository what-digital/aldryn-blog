...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('aldryn_blog_category', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ordering', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('aldryn_blog', ['Category'])

        # Adding model 'CategoryTranslation'
        db.create_table('aldryn_blog_category_translation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('aldryn_blog', ['CategoryTranslation'])

        # Adding unique constraint on 'CategoryTranslation', fields ['slug', 'language_code']
        db.create_unique('aldryn_blog_category_translation', ['slug', 'language_code'])

        # Adding unique constraint on 'CategoryTranslation', fields ['language_code', 'master']
        db.create_unique('aldryn_blog_category_translation', ['language_code', 'master_id'])

        # Adding field 'Post.category'
        db.add_column('aldryn_blog_post', 'category',
    ...
    def backwards(self, orm):
        ...
        db.delete_unique('aldryn_blog_category_translation', ['language_code', 'master_id'])

        # Removing unique constraint on 'CategoryTranslation', fields ['slug', 'language_code']
        db.delete_unique('aldryn_blog_category_translation', ['slug', 'language_code'])

        # Deleting model 'Category'
        db.delete_table('aldryn_blog_category')

        # Deleting model 'CategoryTranslation'
        db.delete_table('aldryn_blog_category_translation')

        # Deleting field 'Post.category'
        db.delete_column('aldryn_blog_post', 'category_id')
