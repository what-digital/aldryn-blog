...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('cmsplugin_authorentriesplugin', 'author_id')

        # Adding M2M table for field authors on 'AuthorEntriesPlugin'
        m2m_table_name = db.shorten_name('aldryn_blog_authorentriesplugin_authors')
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name('aldryn_blog_authorentriesplugin_authors'))
