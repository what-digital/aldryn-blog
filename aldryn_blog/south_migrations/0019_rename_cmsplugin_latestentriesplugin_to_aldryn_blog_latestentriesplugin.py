...
class Migration(SchemaMigration):
    ...
    tables = {
        'cmsplugin_authorsplugin': 'aldryn_blog_authorsplugin',
        'cmsplugin_latestentriesplugin': 'aldryn_blog_latestentriesplugin',
    }

    def forwards(self, orm):
        table_names = connection.introspection.table_names()
        for old_table, new_table in self.tables.items():
    ...
    models = {
        'aldryn_blog.allentriesplugin': {
            'Meta': {'object_name': 'AllEntriesPlugin', '_ormbases': ['cms.CMSPlugin']},
        ...
        'aldryn_blog.categorytranslation': {
            ...
            'master': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'translations'", 'null': 'True', 'to': "orm['aldryn_blog.Category']"}),
        ...
        'aldryn_blog.post': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['aldryn_blog.Category']", 'null': 'True', 'blank': 'True'}),
            'coauthors': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'aldryn_blog_coauthors'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['auth.User']"}),
        ...
        'filer.file': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'owned_files'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['auth.User']"}),
        ...
        'filer.folder': {
            ...
            'modified_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'filer_owned_folders'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['auth.User']"}),
