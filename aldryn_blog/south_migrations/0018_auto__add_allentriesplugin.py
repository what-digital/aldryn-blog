...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AllEntriesPlugin'
        db.create_table('aldryn_blog_allentriesplugin', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('aldryn_blog', ['AllEntriesPlugin'])


    def backwards(self, orm):
        # Deleting model 'AllEntriesPlugin'
        db.delete_table('aldryn_blog_allentriesplugin')
