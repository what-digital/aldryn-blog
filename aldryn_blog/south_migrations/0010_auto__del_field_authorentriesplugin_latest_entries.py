...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('cmsplugin_authorentriesplugin', 'latest_entries')
    ...
    def backwards(self, orm):
        ...
        db.add_column('cmsplugin_authorentriesplugin', 'latest_entries',
                      self.gf('django.db.models.fields.IntegerField')(default=5),
                      keep_default=False)

        # Adding M2M table for field authors on 'AuthorEntriesPlugin'
        db.create_table('aldryn_blog_authorentriesplugin_authors', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('authorentriesplugin', models.ForeignKey(orm['aldryn_blog.authorentriesplugin'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('aldryn_blog_authorentriesplugin_authors', ['authorentriesplugin_id', 'user_id'])

    models = {
        'aldryn_blog.authorentriesplugin': {
