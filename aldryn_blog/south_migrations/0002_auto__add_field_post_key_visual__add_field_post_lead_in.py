...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('aldryn_blog_post', 'key_visual_id')

        # Deleting field 'Post.lead_in'
        db.delete_column('aldryn_blog_post', 'lead_in')
