...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'aldryn_blog_allentriesplugin', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'aldryn_blog', ['AllEntriesPlugin'])


    def backwards(self, orm):
        # Deleting model 'AllEntriesPlugin'
        db.delete_table(u'aldryn_blog_allentriesplugin')


    models = {
        u'aldryn_blog.allentriesplugin': {
